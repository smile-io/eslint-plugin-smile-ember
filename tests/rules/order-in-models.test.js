  ...
  valid: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'The "ripen" member-action should be above the "getAllCitrus" collectionAction on line 2',
          line: 7,
        },
        {
          message:
            'The "a" attribute should be above the "getAllCitrus" collectionAction on line 2',
          line: 10,
        },
        {
          message:
            'The "b" relationship should be above the "getAllCitrus" collectionAction on line 2',
          line: 11,
        },
      ],
    },
  ...
  invalid: [
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'The "convertA" empty method should be above the "getAllCitrus" collectionAction on line 2',
          line: 7,
        },
      ],
    },
